...
\BLOCK{if personal.title}{\large \VAR{personal.title | escape_latex}}\BLOCK{endif} & \BLOCK{for link in personal.links}\BLOCK{if link.url and link.username and loop.first}\href{\VAR{link.url | escape_latex}}{\VAR{link.username | escape_latex}}\BLOCK{endif}\BLOCK{endfor}\\
