...
\begin{center}
  ...
  \BLOCK{set sep = namespace(first=true)}%
  \BLOCK{if personal.location}\VAR{personal.location | escape_latex}\BLOCK{set sep.first=false}\BLOCK{endif}%
  \BLOCK{if personal.email}\BLOCK{if not sep.first} \;|\; \BLOCK{endif}\href{mailto:\VAR{personal.email}}{\VAR{personal.email | escape_latex}}\BLOCK{set sep.first=false}\BLOCK{endif}%
  \BLOCK{if personal.phone}\BLOCK{if not sep.first} \;|\; \BLOCK{endif}\VAR{personal.phone | escape_latex}\BLOCK{set sep.first=false}\BLOCK{endif}%
  \BLOCK{for link in personal.links}\BLOCK{if link.url and link.username}\BLOCK{if not sep.first} \;|\; \BLOCK{endif}\href{\VAR{link.url | escape_latex}}{\VAR{link.username | escape_latex}}\BLOCK{set sep.first=false}\BLOCK{endif}\BLOCK{endfor}
\end{center}
