...
\newcommand{\cvtag}[1]{%
    \begin{tikzpicture}[baseline=(temp.base)]
        \node[inner sep=2pt] (temp) {\textbf{\small #1}};
...
\begin{minipage}[c]{0.22\textwidth}
    \begin{flushright}
        \begin{tikzpicture}
            \node[circle, fill=primary, minimum size=2.2cm, text=white, font=\fontsize{20}{20}\selectfont] {\VAR{personal.name | initials(2)}};
        \end{tikzpicture}
    \end{flushright}
\end{minipage}
...
\BLOCK{if cat.skills}
{\small \textbf{\VAR{cat.category | escape_latex}:} \VAR{cat.skills | escape_latex}}
